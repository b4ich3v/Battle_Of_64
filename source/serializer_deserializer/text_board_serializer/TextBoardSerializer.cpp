...
TextBoardSerializer::TextBoardSerializer(const MyString& fileName):
    BoardSerializer(fileName) {}

void TextBoardSerializer::save(const Board& board) const 
{
...
void TextBoardSerializer::load(Board& board) const 
{
